...
WM_WORD VMCLASS_PREFIX getWORD(WM_ADDRESS x)
{
	WM_WORD res = (*(WM_WORD*)(pgmData + x + wDataOfs));
	return ByteSwap2(res);
}

void VMCLASS_PREFIX setWORD(WM_ADDRESS x, WM_WORD val)
{
	(*(WM_WORD*)(pgmData + x + wDataOfs)) = ByteSwap2(val);
}

WM_DINT VMCLASS_PREFIX getDWORD(WM_ADDRESS x)
{
	WM_DINT res = (*(WM_DINT*)(pgmData + x + wDataOfs));
	return ByteSwap4(res);
}

void VMCLASS_PREFIX setDWORD(WM_ADDRESS x, WM_DINT val)
{
	(*(WM_WORD*)(pgmData + x + wDataOfs)) = ByteSwap4(val);
}
